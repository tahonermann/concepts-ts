...
have unique invented template parameters.
% 
\enterexample
\begin{codeblock}
...
C f3(C c);
\end{codeblock}
The types of \tcode{a}, \tcode{b}, \tcode{c}, and the template arguments to
\tcode{ct} each correspond to unique invented template type parameters.
The return type of \tcode{f3} is deduced from non-discarded return statements,
