...
a function template \tcode{f} with one parameter whose
type is \tcode{T} (\ref{dcl.spec.auto.deduct}).
% 
...
\end{codeblock}
The invented function template \tcode{f} for the
\grammarterm{compound-requirement} in \tcode{C2} is:
\begin{codeblock}
template<C1 T1, typename T2> void f(Pair<T1&, T2>);
\end{codeblock}
...
template<C1 T> void f1(const T*); // OK: \tcode{C1} selects \#1
template<C1<char> T> void f2(T);  // OK: \tcode{C1<char>} selects \#2
...
template<C3... Ts> void q1(); // OK: selects \tcode{C3}
template<C3 T> void q2();     // OK: selects \tcode{C3}
\end{codeblock}
\exitexample
