...
allow a template declaration to specify a \grammarterm{requires-clause}.
...
\nontermdef{template-declaration}\br
  \terminal{template} \terminal{<} template-parameter-list \terminal{>}
    \added{requires-clause\opt} declaration
...
\grammarterm{template-parameter-list} (\ref{temp.param}).
%
